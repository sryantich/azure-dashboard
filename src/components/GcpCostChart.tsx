...
const MONTHLY_DATA = [
  { name: "Aug", cost: 5800, budget: 6500 },
  { name: "Sep", cost: 6150, budget: 6500 },
  { name: "Oct", cost: 5680, budget: 6500 },
  { name: "Nov", cost: 6420, budget: 6500 },
  { name: "Dec", cost: 5990, budget: 7000 },
  { name: "Jan", cost: 6380, budget: 7000 },
  { name: "Feb", cost: 6750, budget: 7000 },
  { name: "Mar", cost: 7280, budget: 7500 },
  { name: "Apr", cost: 6920, budget: 7500 },
  { name: "May", cost: 7650, budget: 7500 },
  { name: "Jun", cost: 7380, budget: 8000 },
  { name: "Jul", cost: 8120, budget: 8000 },
];

export default function GcpCostChart() {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4 relative z-10">
        <div>
          <h2 className="text-base font-semibold" style={{ color: theme.textPrimary }}>GCP Monthly Spend</h2>
          <p className="text-[11px] mt-0.5" style={{ color: theme.textMuted }}>12-month rolling &bull; Billing Console</p>
        </div>
      ...
      <div className="h-40 sm:h-48 w-full relative z-10">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={MONTHLY_DATA} margin={{ top: 5, right: 0, bottom: 5, left: -20 }}>
            <defs>
              <linearGradient id="gcpCostGradient" x1="0" y1="0" x2="0" y2="1">
